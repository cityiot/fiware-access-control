...
config.https = {
    ...
    key_file: '/run/secrets/private_key',
    ca_certs: [],
...
config.authorization = {
    ...
    level: (process.env.IDM_PDP_LEVEL || 'advanced'),
    authzforce: {
        //enabled: to_boolean(process.env.IDM_AUTHZFORCE_ENABLED, false),
        enabled: to_boolean(process.env.IDM_AUTHZFORCE_ENABLED, true),
        host: (process.env.IDM_AUTHZFORCE_HOST || 'http://authzforce'),
